...
export default function Contact() {
  return (
    <section id="contact" className="bg-[#0f0f12] text-white py-20 px-6 md:px-10">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid sm:grid-cols-2 gap-6 mb-12">
          {/* Email */}
          <div className="flex flex-col sm:flex-row items-center sm:items-start p-6 bg-[#1b1b1f] rounded-2xl shadow-md hover:bg-[#232327] transition-all">
            <div className="p-3 bg-orange-600/20 rounded-lg mb-3 sm:mb-0 sm:mr-4">
              <Mail className="text-orange-400" />
            </div>
            <div className="text-center sm:text-left">
              <p className="text-sm text-gray-400">Email</p>
              <p className="font-medium break-all">mahiya.rehman@example.com</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start p-6 bg-[#1b1b1f] rounded-2xl shadow-md hover:bg-[#232327] transition-all">
            ...
            <div className="text-center sm:text-left">
              ...
              <a
                href="https://linkedin.com/in/mahiya-rehman"
